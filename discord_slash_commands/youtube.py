...
class YoutubeFile():
    ...
    def __init__(self, url: str):
        ...
        # <<<
        # Sometimes on the first request of a video, the output is
        # in an unexpected format or none
        # TODO: make it so it works on the first attempt
        self.logger.print_log()
...
async def youtube_play(
    ...
    for youtube_file in youtube_file_list:
        ...
        # TODO: use different thread to download and queue audio? but, delteion issues?
